...
const services = [
  {
    title: "Engine Repair",
    description:
      "Complete engine diagnostics, repair, and rebuilds to keep your vehicle running at peak performance.",
    icon: (
  ...
  },
  {
    title: "Oil Change",
    description:
      "Regular oil changes with premium synthetic and conventional oils to extend engine life.",
    icon: (
      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2v6l3 3" />
  ...
  },
  {
    title: "Brake Service",
    description:
      "Brake pad replacement, rotor resurfacing, and complete brake system inspections for your safety.",
    icon: (
      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    title: "Diagnostics",
    description:
      "Advanced computer diagnostics to identify issues accurately and save you time and money.",
    icon: (
      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    title: "Tire Services",
    description:
      "Tire rotation, balancing, alignment, and replacement to ensure a smooth and safe ride.",
    icon: (
      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="12" cy="12" r="10" />
  ...
  },
  {
    title: "AC Repair",
    description:
      "Air conditioning inspection, recharging, and repair to keep you cool all year round.",
    icon: (
      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2v20" />
        <path d="M2 12h20" />
  ...
  return (
    <div className="text-[#EDEDEC]">
      ...
      <section
        data-section
        id="about"
        className="flex h-screen w-full items-center bg-black px-6 lg:px-8"
      >
        <div className="mx-auto w-full max-w-5xl">
          ...
          <p className="mx-auto mb-10 max-w-3xl text-center text-lg leading-relaxed text-gray-300">
            ...
            every vehicle deserves out-of-this-world care. We combine
            cutting-edge technology with old-fashioned dedication to deliver
          ...
          <div className="mb-10 grid gap-6 md:grid-cols-2">
            <div className="rounded-lg bg-[#625959]/10 p-8 backdrop-blur-sm">
              <h3 className="mb-3 text-2xl font-semibold text-[#D9AF01]">
                Our Mission
              </h3>
      ...
      >
        <div className="mx-auto w-full max-w-5xl">
          <div className="mb-12 text-center">
            <h2 className="mb-3 text-4xl font-bold text-[#D9AF01]">
              Our Services
            </h2>
            <p className="text-lg text-gray-400">
              Comprehensive automotive care for every make and model
            </p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((service) => (
              ...
              >
                <div className="mb-4 text-[#D9AF01] transition-transform duration-300 group-hover:scale-110">
                  {service.icon}
                </div>
                <h3 className="mb-2 text-lg font-semibold text-[#EDEDEC]">
                  {service.title}
                </h3>
